...
{
  "overrides": {
    "@rnoh/react-native-openharmony": "~0.82.18" // ohpm version
...
│   ├── nestedScrollNativeComponent.ts  # Native component Codegen declaration of NestedScrollView
│   └── NestedScrollViewHeader    # NestedScrollViewHeader component
│       ├── index.tsx             # NestedScrollViewHeader component wrapper
│       └── nestedScrollHeaderNativeComponent.ts  # Native component Codegen declaration of the Header
